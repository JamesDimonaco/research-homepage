...
interface HeaderProps {
  /** The site/researcher name to display in the header */
  siteName: string;
  /** Counts of content types to conditionally show nav items */
  contentCounts: ContentCounts;
}

const Header = ({ siteName, contentCounts }: HeaderProps) => {
