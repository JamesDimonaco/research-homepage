...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "URL Path",
      type: "slug",
      description: "This creates the web address for your talk. Click 'Generate' to create it from your title. Example: 'Keynote at NeurIPS 2024' → 'keynote-at-neurips-2024'",
      options: {
        source: "title",
        maxLength: 96,
      },
