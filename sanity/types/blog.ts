...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "URL Path",
      type: "slug",
      description: "This creates the web address for your blog post. Click 'Generate' to auto-create from title. Example: 'My First Blog Post' → 'my-first-blog-post'. The full URL will be: yoursite.com/blog/my-first-blog-post",
      options: {
        source: "title",
        maxLength: 96,
      },
